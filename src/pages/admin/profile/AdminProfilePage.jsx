    ...
    const fetchData = async () => {
        try {
            ...
            await LogService.createLog({
                ...
                "ui": "AdminProfilePage",
                "method": "fetchData()",
                "errorMsg": error.message || "Admin Profile failed"
            });
            ...
            <div className="relative">
                ...
                <div className="m-4 flex justify-end">
                    <Button
                        ...
                        className="bg-blue-500 text-white font-semibold rounded-xl shadow-lg 
                                   hover:shadow-xl hover:bg-blue-400 hover:scale-105 transition-all duration-300 
